...
class Cloud(models.Model):
    ...
    aws_key_pair = models.CharField(blank=False, max_length=50,
...
class Instance(models.Model):
    ...
    role = models.ForeignKey(Role)
    cloud = models.ForeignKey(Cloud)
    hostname = models.CharField(blank=False, max_length=30)
    instance_id = models.CharField(max_length=10,
        verbose_name='Instance ID')
    instance_type = models.CharField(blank=False, max_length=10,
